...
print("Server Bancomat attivo sulla porta "..serverPort)
...
while true do
    ...
    elseif message.cmd == "deposita" then
        local cardKey = message.cardKey
        local quanti = message.amount or 0
    ...
    -- Rispondi sempre al canale del client
    modem.transmit(replyChannel, serverPort, response)
end
